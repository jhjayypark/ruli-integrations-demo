...
import { CheckIcon, ExternalLinkIcon } from "@/components/ui/lucide-shim";
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-6 p-4">
        ...
        {DEMO_INTEGRATION_CATEGORIES.filter((section) => activeTab === "All" || section.category === activeTab).map(
          (section) => (
